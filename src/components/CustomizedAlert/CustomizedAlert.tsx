...
const CustomizedAlert = ({ type = 'info', message, noElevation }: CustomizedAlertProps) => {

  const Alert = React.forwardRef<HTMLDivElement, AlertProps>(function Alert(
    props,
    ref,
  ) {
    return <MuiAlert elevation={noElevation ? 0 : 6} sx={{ width: '100%', boxSizing: 'border-box' }} ref={ref} variant="filled" {...props} />;
  });
